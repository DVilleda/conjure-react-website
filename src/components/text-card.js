...
import '../assets/css/text-card.css'

const TextCard = (props) => {
  return (
    <div className={`text-card-feature-card ${props.rootClassName} `}>
      <svg viewBox="0 0 1024 1024" className="text-card-icon">
        <path
      ...
      <h2 className="text-card-text">{props.title}</h2>
      <span className="text-card-text1">{props.description}</span>
      <span className="text-card-text2">{props.action}</span>
    </div>
  )
}
